...
class ArucoDetector:
    def __init__(self, camera_id):
        ...
        while True:
            ...
            assert frame.shape[0] == 720 and frame.shape[1] == 1280
    ...
    def start_video(self, output_dir):
        ...
        if self.output_vid_flag:
            ...
            self.output_video = cv2.VideoWriter(os.path.join(self.output_dir, f'output_video_{self.vid_save_count}.avi'), self.fourcc, 5, (1280, 720))
